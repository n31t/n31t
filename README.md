...
<p align = "center">
     <a href="https://skillicons.dev">
        <img style="margin: 10px"src="https://skillicons.dev/icons?i=git,github,java,py,js,ts,react,nextjs,css,html,tailwind,nodejs,express,fastapi,nestjs,postgres,go,django,prisma,mongo,docker,rabbitmq,redis&perline=8"alt="My Skills"/>  <!-- Will update it time to time -->
    </a>
</p>
</div>
<br>
