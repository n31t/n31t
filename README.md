...
<p align = "center">
     <a href="https://skillicons.dev">
        <img style="margin: 10px"src="https://skillicons.dev/icons?i=git,github,java,py,js,ts,angular,react,nextjs,css,html,tailwind,go,django,nodejs,express,postgres,prisma,mongo,docker&perline=8"alt="My Skills"/>  <!-- Will update it time to time -->
    </a>
</p>
</div>
<br>
